...
`;
    ...
    _dotsStart() {
      const allMsgs = [
        ...
        'Verificando prazos ANS…',
        'Comparando com mês anterior…',
        'Lendo JSON consolidado…',
        'Identificando padrões…',
        'Avaliando tendências…',
        'Preparando recomendações…',
        'Filtrando por postos selecionados…',
        'Analisando especialidades…',
        'Verificando agenda médica…',
        'Consultando vagas disponíveis…',
        'Calculando score de saúde…',
        'Detectando problemas sistêmicos…',
        'Verificando churn operacional…',
        'Analisando gaps de prazo…',
        'Mapeando vizinhos geográficos…',
        // ── CAMIM e equipe ──
        'Verificando com a Operadora Camim…',
        'Perguntando ao Cristiano…',
        'Verificando se a Victória já resolveu isso…',
        'Janderson resolveu isso já, mas outra coisa parou de funcionar…',
        'Leonardo mexendo no banco, espere um pouco…',
        'Washington chegou na unidade onde está meu servidor, parei de funcionar…',
        'Cristiano pediu pra eu ser mais rápida, estou tentando…',
        'Victória conferindo se os dados batem…',
        'Leonardo otimizando uma query, já volto…',
        'Janderson reiniciou o servidor, estou voltando…',
        'Washington desligou o ar condicionado do servidor, estou suando…',
        'Cristiano olhando o dashboard do outro lado…',
        'Victória disse que esse dado está certo, confia…',
        'Janderson falou que é culpa do banco, investigando…',
        'Leonardo fazendo backup, segura um pouco…',
        'Washington tropeçou no cabo de rede, reconectando…',
        'Cristiano conferindo no SQL Server…',
        'Victória atualizando a planilha de metas…',
        'Janderson disse: "funciona na minha máquina"…',
        'Leonardo criou um índice novo, tá mais rápido agora…',
        'Washington abriu a porta do rack, ventilando o servidor…',
        'Cristiano pediu análise detalhada, vai demorar um pouquinho…',
        'Victória revisando os cancelamentos do mês…',
        'Janderson deployou em produção numa sexta às 17h…',
        'Leonardo fazendo ALTER TABLE, reze por mim…',
        'Washington testando se o nobreak funciona…',
        // ── Humor técnico ──
        'Gastando seus tokens :)',
        'Isso aqui não é de graça, sabia?',
        'Cada token conta… literalmente.',
        'Se demorar, a culpa é do modelo, não minha.',
        'Processando… ou fingindo que processo.',
        'Lendo 67 mil caracteres de contexto, calma…',
        'Sou rápida, mas não faço milagre.',
        'Meu estagiário está digitando a resposta…',
        'Convertendo café em dados…',
        'Consultando o oráculo… quer dizer, o Groq.',
        'A resposta está quase pronta, juro.',
        'Estou pensando… sim, IA também pensa.',
        'Rodando mais rápido que o Excel do financeiro…',
        'Fazendo em segundos o que levaria horas na planilha…',
        'Calculando… sem usar PROCV.',
        'Não travei, só estou pensando profundamente.',
        'SELECT resposta FROM cerebro WHERE pergunta = a_sua…',
        'pip install paciencia…',
        'Carregando módulo de inteligência… found.',
        'Alocando neurônios artificiais…',
        'Desfragmentando pensamentos…',
        'Compilando sabedoria…',
        'Indexando experiência de 20 anos…',
        'Conectando os pontos…',
        'Separando o que importa do que não importa…',
        'Priorizando informações críticas…',
        // ── Sobre a CAMIM ──
        'Quem tem saúde é mais feliz… e quem tem dados também.',
        'Analisando a rede inteira, posto por posto…',
        'Verificando os 13 postos… um por um.',
        'Mais dados que paciente em segunda-feira de manhã…',
        'Corredor Japeri ou Santa Cruz? Analisando os dois…',
        'Cruzando agenda com churn com vendas com metas…',
        'Se a ANS soubesse que eu analiso tudo isso em segundos…',
        'Avaliando se precisa contratar ou remanejar…',
        'Checando se algum posto está sem vaga…',
        'Comparando Zona Norte com Baixada…',
        'Verificando qual posto precisa de reforço…',
        'Analisando capacidade de agenda…',
        'Conferindo prazo CAMIM vs prazo ANS…',
        'Mapeando especialidades críticas…',
        'Buscando alternativas de remanejamento…',
        'Calculando impacto no negócio…',
        'Avaliando score de saúde por região…',
        // ── Meta e filosóficas ──
        'Trabalhando enquanto você toma café…',
        'Eu não descanso, mas aceito um upgrade de modelo…',
        'IA não tem hora extra, mas deveria…',
        'Analisando dados como se fossem o sentido da vida…',
        'Se a resposta for boa, lembra de mim na avaliação…',
        'Estou dando o meu melhor, prometo.',
        'Mais um dia, mais uma análise.',
        'Você pergunta, eu respondo. Simples assim.',
        'Sem planilha, sem PROCV, sem sofrimento.',
        'Quem precisa de BI quando tem eu?',
        'Depois dessa análise, mereço um upgrade…',
        'A fila anda… e a resposta também.',
      ];
      // Embaralha e pega 12 mensagens aleatórias para esta sessão
      const msgs = allMsgs.sort(() => Math.random() - 0.5).slice(0, 12);
